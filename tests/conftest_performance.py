...
@pytest.fixture
def performance_load_tester():
    """Performance load tester fixture."""
...
@pytest.fixture
def performance_memory_profiler():
    """Performance memory profiler fixture."""
    ...
    return PerformanceMemoryProfiler()


@pytest.fixture
def performance_cpu_profiler():
    """Performance CPU profiler fixture."""
    class PerformanceCPUProfiler:
        def __init__(self):
            self.samples = []
    ...
    return PerformanceCPUProfiler()


@pytest.fixture
def performance_network_profiler():
    """Performance network profiler fixture."""
    class PerformanceNetworkProfiler:
        def __init__(self):
            self.samples = []
    ...
    return PerformanceNetworkProfiler()


@pytest.fixture
def performance_database_profiler():
    """Performance database profiler fixture."""
    class PerformanceDatabaseProfiler:
        def __init__(self):
            self.queries = []
    ...
    return PerformanceDatabaseProfiler()


@pytest.fixture
def performance_agent_tester():
    """Performance agent tester fixture."""
    class PerformanceAgentTester:
        def __init__(self):
            self.agent_tests = []
    ...
    return PerformanceAgentTester()


@pytest.fixture
def performance_backend_tester():
    """Performance backend tester fixture."""
    ...
    return PerformanceBackendTester()


@pytest.fixture
def performance_scalability_tester():
    """Performance scalability tester fixture."""
    ...
    return PerformanceScalabilityTester()